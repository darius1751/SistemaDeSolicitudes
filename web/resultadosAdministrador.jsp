    ...
    <body>
        ...
        <%
             if (request.getParameter("btnRegistrar") != null) {
                EstudianteDTO estudianteDTO = new EstudianteDTO("sistemadesolicitudesvero");
            ...
            break;
            case 2:
                LinkedList<Solicitud> solicitudes = new SolicitudDAO("sistemadesolicitudesvero").solicitudes();
                if (solicitudes != null) {
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <select required name='cmbxEstado'>
                            ...
                            <%
                                EstadoDAO estadoDAO = new EstadoDAO("sistemadesolicitudesvero");
        ...
        <%break;
            ...
            if (request.getParameter("btnRegistrarRespuesta") != null) {
                SolicitudDTO solicitudDTO = new SolicitudDTO("sistemadesolicitudesvero");
